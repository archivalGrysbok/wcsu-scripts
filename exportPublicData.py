# code heavily based off of https://github.com/UAlbanyArchives/ArchivesSpace-ArcLight-Workflow/blob/master/exportPublicData.py . Thanks, University of Albany Archives!
 Univers
# -*- coding: utf-8 -*-
import os
import sys
...
output_path = "/var/www/html/ASOutput"
#pdf_path = "/home/haponiks/temp/pdf"
...
#                    checkCollection = True
            ...
            if checkExport != True:
                ...
                #sorting collection
                eadDir = output_path
#                eadDir = os.path.join(output_path, "default")
...
#                print ("\t\t\tExporting PDF")
#                pdfResponse = client.get("repositories/3/resource_descriptions/" + resourceID + ".pdf")
