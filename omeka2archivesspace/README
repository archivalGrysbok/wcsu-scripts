These scripts were stacked in order to automate the creation of digital "items" in our instance of Omeka and creation of digital instances in ArchivesSpace.
...
grabFromCSV.py then is run to "grab" elements from the csv file and feed add them to a JSON object that is imported into ArchivesSpace.
